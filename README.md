...
해당 문제들을 해결하기 위해 [이전의 경험](https://velog.io/@eora21/너나드리-Implement-Layer를-통한-이미지-파일-저장과-Entity-영속화에-대한-고민-해결-과정)과 같이 `operator`라는 계층을 추가해보기로 했으나, 실질적인 시간 부족으로 포기해야 했습니다.

(제출 당일인 6월 28일에 갑작스런 일정이 생겨, 27일 저녁부터 작업이 불가하게 되었습니다. 따라서 계획했던 내용을 완료하지 못하고 부득이하게 제출하게 되었습니다.)
